...
const intro_data: DataType[] = [
...

   {
      ...
      title: "Website Gratis Ramadan",
      desc: "Dapatkan website profesional gratis khusus UMKM & Company Profile selama bulan Ramadan.",
   },
   {
      id: 2,
      page: "home_4",
      ...
      desc: "Domain dan hosting aktif 1 tahun tanpa biaya, langsung online dan siap pakai!",
   },
   {
      id: 3,
      page: "home_4",
      icon_img: introIcon_3,
      title: "Kolaborasi Partner Terpercaya",
      desc: "Dibuat oleh inticode.store, didukung pendanaan businesssupport.asia. Daftar mudah, proses cepat!",
   },
