          ...
          <div className="col-lg-6 align-self-center order-lg-first">
            <div className="section-title px-lg-5 mb-0">
              ...
              <p className="content mb-lg-5">
                Komitmen kami menghadirkan solusi digital untuk UMKM & company
                profile.
                <br />
                Selama Ramadan, dapatkan website template, domain, dan hosting
                gratis (kuota 20 orang).
              </p>
              <div className="choose-wrap mt-4 pe-xl-5">
                <div className="media single-choose-inner">
                  ...
                  <div className="media-body">
                    <h4>Komitmen Kami</h4>
                    <p>
                      Kami ingin UMKM & compro bisa go digital dengan mudah,
                      tanpa biaya, dan didampingi partner terpercaya.
                    </p>
                  </div>
                </div>
                <div className="media single-choose-inner">
                  ...
                  <div className="media-body">
                    <h4>Misi Ramadan</h4>
                    <p>
                      Memberikan akses website gratis, domain & hosting, serta
                      desain siap pakai untuk 20 UMKM/compro selama Ramadan.
                    </p>
                  </div>
                </div>
              </div>
              <div className="btn-wrap pt-4">
                <a
                  className="it-btn btn-base mr-space mb-2 mb-md-0"
                ...
                <Link
                  className="it-btn btn-border-base me-2"
