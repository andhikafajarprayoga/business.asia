        ...
        <div className="col-xl-5 col-lg-6 align-self-center">
          <div className="section-title px-lg-5 mb-0">
            <h2 className="title mb-4">
              ...
              Ramadan Berkah untuk UMKM & Compro
              <br /> Website, Domain, dan Hosting Gratis!
            </h2>
            <p className="content mb-lg-5">
              Di bulan Ramadan ini, kami bersama <b>inticode.store</b> dan{" "}
              <b>businesssupport.asia</b> menghadirkan program spesial: <br />
              Website profesional, domain, dan hosting <b>100% gratis</b> untuk
              UMKM & company profile.
              <br />
              Daftar mudah, proses cepat, langsung online tanpa biaya!
            </p>
            <p className="mb-0 bottom-line-url">
