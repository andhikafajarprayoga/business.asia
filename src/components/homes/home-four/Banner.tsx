               ...
               <div className="row">
                  <div className="col-lg-6 col-md-10">
                     <div className="banner-inner style-white">
                        ...
                        <p style={{marginTop: '16px', fontSize: '18px', color: '#fff', lineHeight: '1.6'}}>
                           Dapatkan website, domain, dan hosting <b>gratis</b> untuk bisnis Anda. Program khusus UMKM dan perusahaan yang didukung oleh <b>inticode.store</b> dan <b>businesssupport.asia</b>.
                        </p>
                        <div className="btn-wrap s-animate-4">
                           <Link className="it-btn btn-white mr-space" href="/contact">Daftar Sekarang</Link>
                           <Link className="it-btn btn-border-white" href="https://inticode.store" target="_blank">Tentang Partner</Link>
                        </div>
                     </div>
                  </div>
