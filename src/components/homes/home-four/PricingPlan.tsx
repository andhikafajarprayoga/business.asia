          ...
          <div className="row justify-content-center">
            <div className="col-lg-7">
              <h2 className="title">
                ...
                <span>
                  {" "}
                  <Image src={pricingShape} alt="img" />
                </span>
              </h2>
              <p className="content mt-2">
                Pilih paket website sesuai kebutuhan bisnis Anda.
                <br />
                Khusus Ramadan, tersedia website template gratis domain &
                hosting untuk 20 UMKM/Compro.
                <br />
